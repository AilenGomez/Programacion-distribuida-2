...
using UsersQueueApi.Application;
using UsersQueueApi.Application.Common.Interfaces;
using UsersQueueApi.Infrastructure;
using UsersQueueApi.Infrastructure.Persistence;
using UsersQueueApi.WebUI.Common;
using UsersQueueApi.WebUI.Extensions;
...
namespace UsersQueueApi.WebUI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "UsersQueueApi" });
            });
